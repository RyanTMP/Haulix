...
const de = {
  exact: {
    ...
    "VTC": "VTC", "App": "App", "HAULIX needs no account and no server. All data stays on this PC; only the optional update check asks GitHub for the latest version.": "HAULIX braucht kein Konto und keinen Server. Alle Daten bleiben auf diesem PC; nur die optionale Update-Prüfung fragt GitHub nach der neuesten Version.",
  ...
  patterns: [
    ...
    [/^on time · (.+) spare$/, "pünktlich · $1 Puffer"], [/^Real time · (.+)$/, "Echtzeit · $1"],
