...
const de = {
  exact: {
    ...
    "Signing in will require accepting Part B of the HAULIX License Agreement (accounts, VTCs, your content, conduct) and the Privacy Policy. Nothing is sent before that.": "Für die Anmeldung musst du Teil B des HAULIX-Lizenzvertrags (Konten, VTCs, deine Inhalte, Verhalten) und die Datenschutzerklärung akzeptieren. Vorher wird nichts gesendet.",
    ...
    "HAULIX is free for personal use under the HAULIX License Agreement. Your data stays on this PC – see the Privacy Policy.": "HAULIX ist für den privaten Gebrauch kostenlos, gemäß dem HAULIX-Lizenzvertrag. Deine Daten bleiben auf diesem PC – siehe Datenschutzerklärung.",
    "Third-party notices": "Hinweise zu Drittanbietern", "HAULIX License Agreement": "HAULIX-Lizenzvertrag", "HAULIX Privacy Policy": "HAULIX-Datenschutzerklärung",
