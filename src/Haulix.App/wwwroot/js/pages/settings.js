...
export default {
      ...
      <div>
        ...
        ${section("online", "Online", html`
          ...
          <div class="setting-group"><div class="setting-group__title">${icon("shield-check")}Terms & privacy</div>
            ${row("Terms for online features", "Signing in will require accepting Part B of the RyanTMP Software License Agreement (accounts, VTCs, your content, conduct) and the Privacy Policy. Nothing is sent before that.", html`<span id="termsState" class="badge badge--outline">${icon("clock", "icon icon-sm")}Not accepted yet</span>`)}
        ...
        ${section("about", "About", html`
          ...
          ${row("License & privacy", "HAULIX is free for personal use under the RyanTMP Software License Agreement. Your data stays on this PC – see the Privacy Policy.", html`<div class="row" style="gap:8px;flex-wrap:wrap;justify-content:flex-end"><button class="btn btn--sm" data-legal="license">${icon("file-text")}License agreement</button><button class="btn btn--sm" data-legal="privacy">${icon("shield")}Privacy policy</button><button class="btn btn--sm btn--ghost" data-legal="thirdparty">${icon("list")}Third-party notices</button></div>`)}
  ...
  async mount(root, { call, params }) {
    ...
    const LEGAL_TITLES = { license: "RyanTMP Software License Agreement", privacy: "HAULIX Privacy Policy", thirdparty: "Third-party notices" };
