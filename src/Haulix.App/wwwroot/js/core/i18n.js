...
const de = {
  exact: {
    ...
    "Accounts, VTCs, job board, events, leaderboards and cloud sync are built into HAULIX already, but there is no server yet – nothing is sent from this PC.": "Konten, VTCs, Auftragsbörse, Events, Bestenlisten und Cloud-Sync sind in HAULIX schon eingebaut, aber es gibt noch keinen Server – von diesem PC wird nichts gesendet.",
    ...
    "Event calendar for your VTC and public convoys": "Eventkalender für deine VTC und öffentliche Konvois", "Meeting point, route and server": "Treffpunkt, Route und Server", "Reminders over the game before the start": "Erinnerungen über dem Spiel vor dem Start",
    ...
    "Record routes": "Routen aufzeichnen", "Store GPS breadcrumbs for the speed profile in delivery details.": "GPS-Punkte für das Geschwindigkeitsprofil in den Lieferdetails speichern.",
    ...
    "Accent colour": "Akzentfarbe", "Width": "Breite", "Row spacing": "Zeilenabstand", "Compact": "Kompakt", "Roomy": "Luftig",
    "How opaque the card is over the game.": "Wie deckend die Karte über dem Spiel ist.", "Rounded corners": "Abgerundete Ecken", "Content": "Inhalt",
    "Header": "Kopfzeile", "“Current job” line with the HAULIX mark.": "Zeile „Aktueller Auftrag“ mit dem HAULIX-Zeichen.", "Cargo name and weight.": "Frachtname und Gewicht.",
    "Start → destination city.": "Start → Zielstadt.", "Progress bar": "Fortschrittsbalken", "What the card lists, in this order.": "Was die Karte anzeigt, in dieser Reihenfolge.",
    "Back to the standard HUD.": "Zurück zum Standard-HUD.", "Reset HUD": "HUD zurücksetzen", "Drag the card to place it": "Karte zum Platzieren ziehen", "Drag to place": "Zum Platzieren ziehen",
    "Top centre": "Oben Mitte", "Middle right": "Mitte rechts", "Middle left": "Mitte links", "Bottom centre": "Unten Mitte", "Custom (dragged)": "Eigene (gezogen)",
    "Same as HAULIX": "Wie HAULIX", "Amber": "Bernstein", "Copper": "Kupfer", "Green": "Grün", "Blue": "Blau", "Red": "Rot", "Purple": "Lila", "White": "Weiß",
    "Destination company": "Zielfirma", "Time of day (PC)": "Uhrzeit (PC)", "Trailer wear": "Anhänger-Verschleiß", "Time": "Uhrzeit",
    "HUD position saved": "HUD-Position gespeichert", "Place the HUD": "HUD platzieren",
    "Switch to your game monitor: drag the card, double-click it to save, right-click to cancel.": "Wechsle zum Spielmonitor: Karte ziehen, Doppelklick speichert, Rechtsklick bricht ab.",
    "Reset the HUD?": "HUD zurücksetzen?", "Position, look and rows go back to the standard HUD.": "Position, Aussehen und Zeilen werden auf das Standard-HUD zurückgesetzt.", "Not available": "Nicht verfügbar",
    // ---- 0.0.7: Achievements
    "All": "Alle", "Career": "Karriere", "Explorer": "Entdecker", "Business": "Unternehmen", "Bronze": "Bronze", "Silver": "Silber", "Gold": "Gold", "Platinum": "Platin",
    "Rookie": "Neuling", "Professional": "Profi", "Expert": "Experte", "Veteran": "Veteran", "Master": "Meister", "Legend": "Legende",
    "Driver rank": "Fahrerrang", "points to": "Punkte bis", "Highest rank reached": "Höchster Rang erreicht", "Points": "Punkte", "Almost there": "Fast geschafft",
    "Next": "Nächstes", "All levels reached": "Alle Stufen erreicht", "Recently unlocked": "Zuletzt freigeschaltet",
    "Deliver your first job to unlock achievements.": "Liefere deinen ersten Auftrag ab, um Erfolge freizuschalten.",
    // ---- 0.0.7: Current job
    "Live data of the job you are driving": "Live-Daten des Auftrags, den du fährst", "Job accepted": "Auftrag angenommen", "Fine": "Bußgeld", "Toll gate": "Mautstelle",
    "No active job": "Kein aktiver Auftrag", "Last delivery": "Letzte Lieferung", "Open logbook": "Fahrtenbuch öffnen",
    "Take a job from the job market, a cargo market or your company – HAULIX shows everything about it here while you drive.": "Nimm einen Auftrag vom Frachtmarkt, Auftragsmarkt oder deiner Firma an – HAULIX zeigt hier alles dazu, während du fährst.",
    "Start ETS2 and take a job – HAULIX shows its route, ETA, costs and your driving score here while you drive.": "Starte ETS2 und nimm einen Auftrag an – HAULIX zeigt hier Route, Ankunft, Kosten und deinen Fahrscore während der Fahrt.",
    "driven": "gefahren", "remaining": "verbleibend", "planned": "geplant", "HAULIX route": "HAULIX-Route", "In-game navigation": "Navigation im Spiel",
    "Late by": "Verspätung", "Deadline in": "Frist in", "Late": "Verspätet", "The live score appears after the first minute of driving.": "Der Live-Score erscheint nach der ersten Fahrminute.",
    "on this job": "auf diesem Auftrag", "Ferries & trains": "Fähren & Züge", "Income after costs": "Einnahmen nach Kosten",
    "Income minus tolls, ferries/trains and fines on this job (fuel is paid from your company account).": "Einnahmen minus Maut, Fähren/Züge und Bußgelder auf diesem Auftrag (Kraftstoff zahlt dein Firmenkonto).",
    "Tolls, ferries, fines and refuelling on this job appear here.": "Maut, Fähren, Bußgelder und Tankstopps dieses Auftrags erscheinen hier.",
    "The speed profile builds up while you drive.": "Das Geschwindigkeitsprofil entsteht während der Fahrt.", "Special transport": "Spezialtransport", "Show on map": "Auf der Karte zeigen",
    "live": "live", "This job so far": "Dieser Auftrag bisher", "Speed profile": "Geschwindigkeitsprofil", "speed and limit over the distance": "Tempo und Limit über die Strecke",
    "Timeline": "Verlauf", "Limit": "Limit", "Per km": "Pro km", "Per mi": "Pro mi",
    "Your progress": "Dein Fortschritt", "No achievements yet": "Noch keine Erfolge", "Deliver your first job to start your driver rank.": "Liefere deinen ersten Auftrag ab, um deinen Fahrerrang zu starten.",
    "HAULIX is preparing to go ONLINE.": "HAULIX bereitet sich darauf vor, ONLINE zu gehen.", "Updates now come more frequently and may add features that are not available yet and do not represent the final version.": "Updates kommen jetzt häufiger und können Funktionen enthalten, die noch nicht verfügbar sind und nicht dem finalen Stand entsprechen.", "Hide until next start": "Bis zum nächsten Start ausblenden",
    "© 2026 RyanTMP. HAULIX is licensed under the GNU GPL v2; the HAULIX name, logo and artwork are all rights reserved.": "© 2026 RyanTMP. HAULIX steht unter der GNU GPL v2; Name, Logo und Grafiken von HAULIX sind urheberrechtlich geschützt (alle Rechte vorbehalten).",
    "HAULIX is an independent fan project, not affiliated with or endorsed by SCS Software, TruckersMP or any other company. Euro Truck Simulator 2 and American Truck Simulator are trademarks of SCS Software; all other names and trademarks belong to their owners.": "HAULIX ist ein unabhängiges Fanprojekt und steht in keiner Verbindung zu SCS Software, TruckersMP oder anderen Unternehmen. Euro Truck Simulator 2 und American Truck Simulator sind Marken von SCS Software; alle anderen Namen und Marken gehören ihren Inhabern.",
    "Game & profile": "Spiel & Profil", "Notifications & sounds": "Benachrichtigungen & Töne", "App, look, data and about": "App, Aussehen, Daten und Info",
    "Game, telemetry, notifications, HUD, TruckersMP": "Spiel, Telemetrie, Benachrichtigungen, HUD, TruckersMP", "Coming later": "Kommt später", "Soon": "Bald",
    "Later HAULIX will support American Truck Simulator too: the same logbook, live job page, HUD and notifications – with miles and dollars. HAULIX works fully with ETS2 today.": "Später unterstützt HAULIX auch American Truck Simulator: dasselbe Fahrtenbuch, Live-Auftragsseite, HUD und Benachrichtigungen – mit Meilen und Dollar. Mit ETS2 funktioniert HAULIX heute schon vollständig.",
    "Logbook and statistics for your ATS company": "Fahrtenbuch und Statistiken für deine ATS-Firma", "Current job page with real-time ETA for ATS": "Seite Aktueller Auftrag mit Echtzeit-ETA für ATS",
    "In-game HUD, notifications and sounds in ATS": "Ingame-HUD, Benachrichtigungen und Töne in ATS",
    "Sounds": "Töne", "Play sounds": "Töne abspielen", "A short chime with notifications, so you notice them while driving.": "Ein kurzer Ton bei Benachrichtigungen, damit du sie beim Fahren bemerkst.",
    "Sound style": "Klangstil", "Soft": "Sanft", "Digital": "Digital", "Job updates": "Auftrags-Updates", "Job accepted, delivered, cancelled and fines.": "Auftrag angenommen, geliefert, abgebrochen und Bußgelder.",
    "Milestones & achievements": "Meilensteine & Erfolge", "Distance milestones, route changes and new achievements.": "Strecken-Meilensteine, Routenänderungen und neue Erfolge.",
    "Deadline, fuel, damage and rest.": "Frist, Kraftstoff, Schaden und Pause.", "AFK warning alarm": "AFK-Warnton",
    "A louder alarm with the TruckersMP inactivity warning – plays even while HAULIX is open.": "Ein lauterer Alarm bei der TruckersMP-Inaktivitätswarnung – auch wenn HAULIX geöffnet ist.", "Play": "Abspielen",
    "cargo market": "Auftragsmarkt", "freight market": "Frachtmarkt", "quick job": "Schnellauftrag", "external contracts": "Externe Aufträge", "external market": "Externer Markt",
    // ---- 0.0.7: About
    "What HAULIX is": "Was HAULIX ist", "Your data": "Deine Daten", "Links": "Links", "Credits": "Danksagungen", "For developers": "Für Entwickler",
    ...
    "made by RyanTMP": "von RyanTMP", "What's new": "Neuigkeiten",
    "Logs every delivery": "Protokolliert jede Lieferung", "with route, income, fuel and a driving score – automatically.": "mit Route, Einnahmen, Kraftstoff und Fahrscore – automatisch.",
    "Live dashboard": "Live-Dashboard", ", current job page, real-time ETA and your driving score.": ", Seite Aktueller Auftrag, Echtzeit-Ankunft und dein Fahrscore.",
    "In-game HUD and notifications": "Ingame-HUD und Benachrichtigungen", "over your game, optionally read out by a natural voice.": "über deinem Spiel, auf Wunsch vorgelesen von einer natürlichen Stimme.",
    "Private:": "Privat:", "no account, no ads, no tracking. Your data stays on this PC.": "kein Konto, keine Werbung, kein Tracking. Deine Daten bleiben auf diesem PC.",
    "Updates": "Updates", "HAULIX looks for new versions on start and every 6 hours and installs them with one click.": "HAULIX sucht beim Start und alle 6 Stunden nach neuen Versionen und installiert sie mit einem Klick.",
    "Logbook, settings and backups are stored only on this PC. The only thing HAULIX asks the internet is whether a new version exists.": "Fahrtenbuch, Einstellungen und Sicherungen liegen nur auf diesem PC. Das Einzige, was HAULIX im Internet fragt, ist, ob es eine neue Version gibt.",
    "Stays on your PC": "Bleibt auf deinem PC", "Website": "Website", "Downloads": "Downloads", "Report a problem": "Problem melden",
    "Live data comes from the free SCS telemetry plugin by RenCloud. Charts with uPlot, icons by Lucide, voices by Piper. HAULIX is free software (GPL v2).": "Live-Daten kommen vom kostenlosen SCS-Telemetrie-Plugin von RenCloud. Diagramme mit uPlot, Icons von Lucide, Stimmen von Piper. HAULIX ist freie Software (GPL v2).",
    "HAULIX is a fan project and is not affiliated with or endorsed by SCS Software or TruckersMP. Euro Truck Simulator 2 is a trademark of SCS Software.": "HAULIX ist ein Fanprojekt und steht in keiner Verbindung zu SCS Software oder TruckersMP. Euro Truck Simulator 2 ist eine Marke von SCS Software.",
    "URL of your own update manifest (JSON with version, url, notes). Leave empty to use GitHub.": "URL deines eigenen Update-Manifests (JSON mit version, url, notes). Leer lassen für GitHub.",
  },
  patterns: [
