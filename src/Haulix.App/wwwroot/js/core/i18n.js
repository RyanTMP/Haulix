...
const de = {
  exact: {
    ...
    "Game, telemetry, HUD, notifications, map": "Spiel, Telemetrie, HUD, Benachrichtigungen, Karte", "Coming later": "Kommt später", "Soon": "Bald",
    "Later HAULIX will support American Truck Simulator too: the same logbook, live job page, HUD and notifications – with miles, dollars and the ATS map. HAULIX works fully with ETS2 today.": "Später unterstützt HAULIX auch American Truck Simulator: dasselbe Fahrtenbuch, Live-Auftragsseite, HUD und Benachrichtigungen – mit Meilen, Dollar und der ATS-Karte. Mit ETS2 funktioniert HAULIX heute schon vollständig.",
    "Logbook and statistics for your ATS company": "Fahrtenbuch und Statistiken für deine ATS-Firma", "ATS road map with navigation to your job": "ATS-Straßenkarte mit Navigation zum Auftrag",
    ...
    "Live dashboard": "Live-Dashboard", ", current job, real-time ETA and a map with the whole ETS2 world.": ", aktueller Auftrag, Echtzeit-Ankunft und eine Karte der ganzen ETS2-Welt.",
    ...
    "Live data comes from the free SCS telemetry plugin by RenCloud. Map with Leaflet, charts with uPlot, icons by Lucide, voices by Piper. HAULIX is free software (GPL v2).": "Live-Daten kommen vom kostenlosen SCS-Telemetrie-Plugin von RenCloud. Karte mit Leaflet, Diagramme mit uPlot, Icons von Lucide, Stimmen von Piper. HAULIX ist freie Software (GPL v2).",
