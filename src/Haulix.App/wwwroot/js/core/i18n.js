...
const de = {
  exact: {
    ...
    "Terms & privacy": "Bedingungen & Datenschutz", "Terms for online features": "Bedingungen für Online-Funktionen",
    "Signing in will require accepting Part B of the RyanTMP Software License Agreement (accounts, VTCs, your content, conduct) and the Privacy Policy. Nothing is sent before that.": "Für die Anmeldung musst du Teil B des RyanTMP-Softwarelizenzvertrags (Konten, VTCs, deine Inhalte, Verhalten) und die Datenschutzerklärung akzeptieren. Vorher wird nichts gesendet.",
    "Not accepted yet": "Noch nicht akzeptiert", "Read the documents": "Dokumente lesen", "License agreement": "Lizenzvertrag", "Privacy policy": "Datenschutzerklärung",
    "Privacy by default": "Datenschutz ab Werk", "When the online service starts, every kind of sharing stays off until you turn it on.": "Wenn der Online-Dienst startet, bleibt jede Art des Teilens aus, bis du sie einschaltest.",
    "Show me on leaderboards": "Mich in Bestenlisten zeigen", "Your name and results on public leaderboards.": "Dein Name und deine Ergebnisse in öffentlichen Bestenlisten.",
    "Share deliveries with my VTC": "Lieferungen mit meiner VTC teilen", "Your deliveries count for your company's statistics.": "Deine Lieferungen zählen für die Statistik deiner Firma.",
    "Back up your logbook to your HAULIX account.": "Sichere dein Fahrtenbuch in deinem HAULIX-Konto.", "License & privacy": "Lizenz & Datenschutz",
    "HAULIX is free for personal use under the RyanTMP Software License Agreement. Your data stays on this PC – see the Privacy Policy.": "HAULIX ist für den privaten Gebrauch kostenlos, gemäß dem RyanTMP-Softwarelizenzvertrag. Deine Daten bleiben auf diesem PC – siehe Datenschutzerklärung.",
    "Third-party notices": "Hinweise zu Drittanbietern", "RyanTMP Software License Agreement": "RyanTMP-Softwarelizenzvertrag", "HAULIX Privacy Policy": "HAULIX-Datenschutzerklärung",
    ...
    "© 2026 RyanTMP. All rights reserved. HAULIX, its name, logo and artwork belong to RyanTMP.": "© 2026 RyanTMP. Alle Rechte vorbehalten. HAULIX, der Name, das Logo und die Grafiken gehören RyanTMP.",
    ...
    "Live data comes from the free SCS telemetry plugin by RenCloud. Charts with uPlot, icons by Lucide, voices by Piper.": "Live-Daten kommen vom kostenlosen SCS-Telemetrie-Plugin von RenCloud. Diagramme mit uPlot, Icons von Lucide, Stimmen von Piper.",
